...
export const handler = async () => ({
  ...
  body: JSON.stringify({
    ...
    endpoints: [
      ...
      'judge-prompts', 'calibration-cron', 'grade-cron', 'grade-cron-background', 'grade-cron-heartbeat', 'judge-context',
      ...
      'multi-league-bet-finder-status', 'ask', 'stale-lines', 'leak-report',
      'sweep-background', 'sweep-status',
    ],
  }, null, 2),
});
